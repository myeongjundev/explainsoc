...
| 카드 | 커밋 | 증거 |
|---|---|---|
| 5 포트폴리오와 제출 | `3dd6274` `2e7bd73` (인용 수정) · 12번 `about` `1dbbbfc` `ea77b4e` | `evidence/card-5.md` |
...
- **제출할 것:** 결과물 URL https://myeongjundev.github.io/explainsoc/ · 실행 묶음
  `explainsoc-2e7bd73.zip` (SHA-256 `a3e65702…42557d2`, 로컬 `release/`) · 짧은 확인 방법과 제출문
...
3. **소스 코드 라이선스(선택).** 지금은 README에 "아직 정하지 않았습니다"로 적혀 있다. 정하면
   LICENSE를 넣고 `npm run release:zip`으로 묶음을 다시 만든다(해시가 바뀐다).
4. **제출.** 결과물 URL과 `release/explainsoc-2e7bd73.zip`, 짧은 확인 방법, 세 줄.
